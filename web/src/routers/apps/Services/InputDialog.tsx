        ...
        >
            {(styles) => <div style={{
                ...
                <div style={{
                    ...
                    <NumberInput onFocus={() => fetchNui("disableControls", true)} onBlur={() => fetchNui("disableControls", false)} placeholder={props.placeholder} style={{ width: '80%', marginTop: '2.31vh' }} styles={{
                        root: {
                            minHeight: '0.00vh',
                            height: '2.31vh',
                        },
